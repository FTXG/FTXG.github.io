...
var MainManager = function () {
    ...
    function o(n) {
        (T = !T) ? ($("#bt_backtrack a").text("背景音效: ON"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("背景音效: OFF"), aidn.util.setCookie("bt", "off", 2592e3)), n && n.preventDefault()
    }
        ...
        var f, u = -1, v = 4, p = 8, y = !1, w = !1, M = [], m = [function (n, a) {
            ...
            this.play = function () {
                !function () {
                    ...
                    u.progress = 0, TweenLite.to(u, f, {progress: 1, ease: Power0.easeNone, onUpdate: d, onComplete: h})
                }()
            };
            var c, f, u = this, v = n;
